...
interface UnitTypesManagerProps {
  /** Base de la API (p.ej. "/api/admin/unit-types" o "/api/collaborator/unit-types"). */
  apiBase: string;
  /** Ruta del botón "Nuevo tipo" (solo se muestra si canCreate). */
  newHref: string;
  canCreate?: boolean;
  canUpdate?: boolean;
  canDelete?: boolean;
...
export function UnitTypesManager({
  ...
  const dragDisabled = !canUpdate || editId !== null;
            ...
            <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
              ...
              >
                <div className="divide-y">
                  {unitTypes.map((u) => (
                    <SortableUnitTypeRow key={u.id} id={u.id} disabled={dragDisabled}>
                      {editId === u.id ? (
                        <>
                          <Input
                            value={editName}
