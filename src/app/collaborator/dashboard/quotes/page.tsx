...
import { getCarrierQuotesColumns } from "@/components/dashboard/carrier-quotes/carrier-quotes-columns";
...
async function fetchQuotes(routeId?: string): Promise<CarrierQuotesResponse> {
  const url = routeId
    ? `/api/collaborator/carrier-quotes?routeId=${routeId}`
    : "/api/collaborator/carrier-quotes";
