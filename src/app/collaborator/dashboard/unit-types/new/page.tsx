...
export default function NewUnitTypePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setIsCreating(true);
    try {
      const res = await fetch("/api/collaborator/unit-types", {
        method: "POST",
      ...
      router.push("/collaborator/dashboard/unit-types");
    } catch (e) {
    ...
    <div className="min-w-0 space-y-6">
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="icon" asChild className="-ml-1">
          <Link href="/collaborator/dashboard/unit-types" aria-label="Volver">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" asChild disabled={isCreating}>
                <Link href="/collaborator/dashboard/unit-types">Cancelar</Link>
              </Button>
