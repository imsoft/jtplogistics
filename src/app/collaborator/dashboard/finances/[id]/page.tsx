...
export default function CollaboratorFinanceReadOnlyPage() {
  const { data: row, isLoaded, error } = useResourceEdit<FinanceShipmentDetail>({
    endpoint: "/api/collaborator/finances",
    redirectHref: "/collaborator/dashboard/finances",
  });
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-center gap-2">
          <Button variant="ghost" size="icon" asChild className="shrink-0">
            <Link href="/collaborator/dashboard/finances" aria-label="Volver a finanzas">
