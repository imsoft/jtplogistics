...
export const metadata = {
  title: "Correos de prueba | JTP Logistics",
  description: "Mandar los correos de la plataforma a una cuenta para revisarlos",
};

export default async function EmailDemosPage() {
