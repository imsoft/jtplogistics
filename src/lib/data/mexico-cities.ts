/**
 * Municipios de México por estado (32 entidades federativas).
 * Fuente: INEGI - Catálogo Único de Claves de Áreas Geoestadísticas (AGEEML).
 * Total: 2,457 municipios y 16 alcaldías de Ciudad de México.
 * Formato para Combobox con grupos: { value: nombre del estado, items: municipios }.
 */
export interface StateCitiesGroup {
  value: string;
  items: string[];
}

export const MEXICO_STATES_CITIES: StateCitiesGroup[] = [
  {
  ...
  },
  {
    ...
    items: ["Comondú", "La Paz", "Loreto", "Los Cabos", "Mulegé"],
  },
  {
    value: "Campeche",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      "San Francisco de Papalotla de Xicohténcatl",
      "San José del Rincón",
